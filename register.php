    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-8 rounded shadow-md">
            ...
            <?php
                ...
                if($success){
                    echo "<p class='text-red-500 mb-4'>$success</p>";
                }
            ?>
            <form action="auth.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Confirmation Password</label>
                    <input type="password" id="password" name="conf_password" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="Enter your password">
                </div>
